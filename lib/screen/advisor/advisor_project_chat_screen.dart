...
class AdvisorProjectChatScreen extends StatefulWidget {
  final ProjectGroup projectGroup;

  const AdvisorProjectChatScreen({super.key, required this.projectGroup});

  @override
  State<AdvisorProjectChatScreen> createState() =>
      _AdvisorProjectChatScreenState();
}

class _AdvisorProjectChatScreenState extends State<AdvisorProjectChatScreen> {
